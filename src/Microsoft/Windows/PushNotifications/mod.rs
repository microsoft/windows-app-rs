...
#[doc(hidden)]
#[repr(transparent)]
pub struct IPushNotificationCreateChannelResultFactory(::windows::core::IUnknown);
unsafe impl ::windows::core::Interface for IPushNotificationCreateChannelResultFactory {
    type Vtable = IPushNotificationCreateChannelResultFactory_Vtbl;
    const IID: ::windows::core::GUID =
        ::windows::core::GUID::from_u128(0x6162a948_0dda_53ae_abcd_5b47f336d612);
}
#[repr(C)]
#[doc(hidden)]
pub struct IPushNotificationCreateChannelResultFactory_Vtbl {
    pub base__: ::windows::core::IInspectableVtbl,
...
unsafe impl ::windows::core::Interface for IPushNotificationManagerStatics {
    ...
    const IID: ::windows::core::GUID =
        ::windows::core::GUID::from_u128(0xa7834d0c_8daf_54e2_8243_cc2e57861b53);
}
#[repr(C)]
#[doc(hidden)]
...
impl PushNotificationManager {
    ...
    pub fn Register(&self) -> ::windows::core::Result<()> {
        let this = self;
        unsafe {
            (::windows::core::Interface::vtable(this).Register)(::core::mem::transmute_copy(this))
                .ok()
        }
    }
    #[doc = "*Required features: `\"Windows_PushNotifications\"`*"]
    pub fn Unregister(&self) -> ::windows::core::Result<()> {
        let this = self;
        unsafe {
            (::windows::core::Interface::vtable(this).Unregister)(::core::mem::transmute_copy(this))
                .ok()
        }
    }
    #[doc = "*Required features: `\"Windows_PushNotifications\"`*"]
    pub fn UnregisterAll(&self) -> ::windows::core::Result<()> {
        let this = self;
        unsafe {
            (::windows::core::Interface::vtable(this).UnregisterAll)(::core::mem::transmute_copy(
                this,
            ))
            .ok()
        }
