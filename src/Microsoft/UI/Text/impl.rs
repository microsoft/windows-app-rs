...
impl ITextCharacterFormat_Vtbl {
    ...
    >() -> ITextCharacterFormat_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetBackgroundColor(::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetForegroundColor(::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetLanguageTag(::core::mem::transmute(&value))
                .into()
        }
...
impl ITextRange_Vtbl {
    ...
    >() -> ITextRange_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetCharacterFormat(::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetFormattedText(::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetParagraphFormat(::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .GetCharacterUtf32(::core::mem::transmute_copy(&value), offset)
                .into()
        }
        unsafe extern "system" fn GetClone<
            Identity: ::windows::core::IUnknownImpl,
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .GetText(options, ::core::mem::transmute_copy(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .GetTextViaStream(options, ::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetPoint(::core::mem::transmute(&point), options, extend)
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetText2(options, ::core::mem::transmute(&value))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetTextViaStream(options, ::core::mem::transmute(&value))
                .into()
        }
