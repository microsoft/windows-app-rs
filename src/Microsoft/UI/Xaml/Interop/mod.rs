...
impl ::core::fmt::Debug for BindableVectorChangedEventHandler {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("BindableVectorChangedEventHandler")
            .field(&self.0)
            .finish()
    }
}
...
impl ::core::fmt::Debug for IBindableObservableVector {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("IBindableObservableVector")
            .field(&self.0)
            .finish()
    }
}
...
impl INotifyCollectionChanged {
    ...
    >(
        ...
        unsafe {
            let mut result__: ::windows::Foundation::EventRegistrationToken = ::core::mem::zeroed();
            (::windows::core::Interface::vtable(this).CollectionChanged)(
                ::core::mem::transmute_copy(this),
                handler.into_param().abi(),
                &mut result__,
            )
    ...
    >(
        ...
        let this = self;
        unsafe {
            (::windows::core::Interface::vtable(this).RemoveCollectionChanged)(
                ::core::mem::transmute_copy(this),
                token.into_param().abi(),
            )
            .ok()
...
impl ::core::fmt::Debug for INotifyCollectionChanged {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("INotifyCollectionChanged")
            .field(&self.0)
            .finish()
    }
}
...
impl ::core::fmt::Debug for NotifyCollectionChangedAction {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("NotifyCollectionChangedAction")
            .field(&self.0)
            .finish()
    }
}
...
impl NotifyCollectionChangedEventArgs {
    ...
    pub fn Action(&self) -> ::windows::core::Result<NotifyCollectionChangedAction> {
        ...
        unsafe {
            ...
            (::windows::core::Interface::vtable(this).Action)(
                ::core::mem::transmute_copy(this),
                &mut result__,
            )
    ...
    pub fn NewItems(&self) -> ::windows::core::Result<IBindableVector> {
        ...
        unsafe {
            let mut result__: ::windows::core::RawPtr = ::core::mem::zeroed();
            (::windows::core::Interface::vtable(this).NewItems)(
                ::core::mem::transmute_copy(this),
                &mut result__,
            )
    ...
    pub fn OldItems(&self) -> ::windows::core::Result<IBindableVector> {
        ...
        unsafe {
            let mut result__: ::windows::core::RawPtr = ::core::mem::zeroed();
            (::windows::core::Interface::vtable(this).OldItems)(
                ::core::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<IBindableVector>(result__)
    ...
    pub fn NewStartingIndex(&self) -> ::windows::core::Result<i32> {
        ...
        unsafe {
            ...
            (::windows::core::Interface::vtable(this).NewStartingIndex)(
                ::core::mem::transmute_copy(this),
                &mut result__,
            )
    ...
    pub fn OldStartingIndex(&self) -> ::windows::core::Result<i32> {
        ...
        unsafe {
            let mut result__: i32 = ::core::mem::zeroed();
            (::windows::core::Interface::vtable(this).OldStartingIndex)(
                ::core::mem::transmute_copy(this),
                &mut result__,
            )
            .from_abi::<i32>(result__)
    ...
    >(
        ...
        Self::INotifyCollectionChangedEventArgsFactory(|this| unsafe {
            let mut result__: ::windows::core::RawPtr = ::core::mem::zeroed();
            (::windows::core::Interface::vtable(this).CreateInstanceWithAllParameters)(
                ::core::mem::transmute_copy(this),
                action,
    ...
    #[doc = "*Required features: `\"UI_Xaml_Interop\"`*"]
    pub fn CreateInstanceWithAllParameters_compose<
        'a,
        Param1: ::windows::core::IntoParam<'a, IBindableVector>,
        Param2: ::windows::core::IntoParam<'a, IBindableVector>,
...
impl ::core::fmt::Debug for NotifyCollectionChangedEventArgs {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("NotifyCollectionChangedEventArgs")
            .field(&self.0)
            .finish()
    }
}
...
impl ::core::fmt::Debug for NotifyCollectionChangedEventHandler {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_tuple("NotifyCollectionChangedEventHandler")
            .field(&self.0)
            .finish()
    }
}
