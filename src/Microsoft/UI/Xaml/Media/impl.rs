...
impl IBrushOverrides_Vtbl {
    ...
    >() -> IBrushOverrides_Vtbl {
        ...
        Self {
            base: ::windows::core::IInspectableVtbl::new::<Identity, IBrushOverrides, OFFSET>(),
...
impl ISurfaceImageSourceManagerNative_Vtbl {
    ...
    >() -> ISurfaceImageSourceManagerNative_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .FlushAllSurfacesWithDevice(::core::mem::transmute(&device))
                .into()
        }
        Self {
...
impl ISwapChainBackgroundPanelNative_Vtbl {
    ...
    >() -> ISwapChainBackgroundPanelNative_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetSwapChain(::core::mem::transmute(&swapchain))
                .into()
        }
        Self {
            base: ::windows::core::IUnknownVtbl::new::<Identity, OFFSET>(),
...
impl ISwapChainPanelNative2_Vtbl {
    ...
    >() -> ISwapChainPanelNative2_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .SetSwapChainHandle(::core::mem::transmute_copy(&swapchainhandle))
                .into()
        }
        Self {
            base: ISwapChainPanelNative_Vtbl::new::<Identity, Impl, OFFSET>(),
...
impl IVirtualSurfaceImageSourceNative_Vtbl {
    ...
    >() -> IVirtualSurfaceImageSourceNative_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .Invalidate(::core::mem::transmute(&updaterect))
                .into()
        }
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .RegisterForUpdatesNeeded(::core::mem::transmute(&callback))
                .into()
        }
...
impl IXamlLightOverrides_Vtbl {
    ...
    >() -> IXamlLightOverrides_Vtbl {
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .OnConnected(::core::mem::transmute(&newelement))
                .into()
        }
        unsafe extern "system" fn OnDisconnected<
            Identity: ::windows::core::IUnknownImpl,
        ...
        >(
            ...
            let this = (*this).get_impl() as *mut Impl;
            (*this)
                .OnDisconnected(::core::mem::transmute(&oldelement))
                .into()
        }
        Self {
